package com.learning.spring.boot.util;
...
/**
 * @Package: com.learning.spring.boot.util
 * @ClassName: MybatisPlusSqlGenerator
 * @Author: beibei.huang
...
public class MybatisPlusSqlGenerator {
    ...
    private static final String PACKAGE_NAME = "com.learning.spring.boot";
    private static final String MODULE_NAME = "com.learning.spring.boot.domain";
    private static final String OUT_PATH = "D:\\";
    private static final String AUTHOR = "BerryHuang";

    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/spring_boot_actual_combat?useUnicode=true&characterEncoding=UTF-8";
