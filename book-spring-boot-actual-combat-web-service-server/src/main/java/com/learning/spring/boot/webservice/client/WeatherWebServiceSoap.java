...
public interface WeatherWebServiceSoap {
    ...
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportCityResponse")
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportProvinceResponse")
     ...
     * 
     * @return
     *     returns com.learning.spring.boot.webservice.client.GetSupportDataSetResponse.GetSupportDataSetResult
     */
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetSupportDataSetResponse")
    public com.learning.spring.boot.webservice.client.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetWeatherbyCityNameResponse")
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.learning.spring.boot.webservice.client.GetWeatherbyCityNameProResponse")
