...
public class DeptController {
    ...
    public ResponseBo getDept(Long deptId) {
        try {
            TDept dept = this.deptService.findById(deptId);
    ...
    @RequiresPermissions("dept:list")
    @ResponseBody
    public List<TDept> deptList(Dept dept) {
        try {
    ...
    public ResponseBo deptExcel(Dept dept) {
        try {
            List<TDept> list = this.deptService.findAllDepts(dept);
    ...
    public boolean checkDeptName(String deptName, String oldDeptName) {
        ...
        TDept result = this.deptService.findByName(deptName);
        return result == null;
    }
